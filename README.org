...
Additional brushes are available. They give a 2.5 dimensions aspect to
boxes. (More that the 2 dimensions of a flat paper and less than our 3
dimensions world).
...
2.5 D brushes are still experimental and waiting for user
feedback. They are available through the Hydra & Transient
interfaces. Just type =INS b= to bring a menu of available brushes.

See [[#the-25-dimensions-brushes]]
